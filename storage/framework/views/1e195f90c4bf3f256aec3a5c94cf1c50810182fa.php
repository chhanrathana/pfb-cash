<div class="card">
    ...
    <div class="card-body">
        <form action="<?php echo e(route('report-financial.revenue-admin-fee')); ?>" method="GET">
            <?php echo csrf_field(); ?>
            <div class="form-row">
                ...
                <div class="col-sm-12 col-md-3 col-lg-3 col-xl-3 mb-1">
                    ...
                    <a href="<?php echo e(route('report-financial.revenue-admin-fee')); ?>" class="btn btn-warning mb-2">សំអាត</a>                    
                </div>
            </div>
        </form>
    </div>
</div><?php /**PATH D:\OneDrive - Cyber Grow Solution Co., Ltd\Desktop\Loan\Source Code\resources\views/report-financials/revenue-admin-fees/search.blade.php ENDPATH**/ ?>