...
<?php $__env->startSection('content'); ?>
    ...
    <form action="<?php echo e(route('loan.daily.update',['id' => $loan->id ])); ?>" method="POST">
        <?php echo csrf_field(); ?>
                ...
                <div class="row">
                    ...
                    <div class="form-group col-sm-4">
                        ...
                        <input
                            ...
                            placeholder="0.7"
                            maxlength="6"
                            value="<?php echo e(old('principal_amount')??$loan->rate); ?>"
                            >
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\OneDrive - Cyber Grow Solution Co., Ltd\Desktop\Loan\Source Code\resources\views/loans/daily/edit.blade.php ENDPATH**/ ?>