<?php $__env->startSection('title','បញ្ចូល-ចំណាយ'); ?>

<?php $__env->startSection('content'); ?>
<?php echo $__env->make('includes.alert-info', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    <div class="card">
        <div class="card-header">
            <strong>បញ្ចូល-ចំណាយ</strong>
        </div>
        <form action="<?php echo e(route('expense.item.store')); ?>" method="POST">
            <?php echo csrf_field(); ?>
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="form-group col-sm-4">
                        <label>ពណ៍នាចំណាយ <span class="text-danger">*</span></label>
                        <input
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\OneDrive - Cyber Grow Solution Co., Ltd\Desktop\Loan\Source Code\resources\views/expenses/expense-items/create.blade.php ENDPATH**/ ?>