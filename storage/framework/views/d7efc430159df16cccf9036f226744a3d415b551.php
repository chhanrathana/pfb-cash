<div class="card">
    ...
    <div class="card-body">
        <form action="<?php echo e(route('report-financial.expense')); ?>" method="GET">
            <?php echo csrf_field(); ?>
            ...
            <div class="form-row">
                ...
                <div class="col-sm-12 col-md-3 col-lg-3 col-xl-3 mb-1">
                    <select class="form-control select2" name="expense_type_id" >
                        ...
                        <option value="all" <?php echo e(request('expense_type_id') == 'all'?'selected':''); ?>>ទាំងអស់</option>
                        <?php $__currentLoopData = $types; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($type->id); ?>" <?php echo e(request('expense_type_id') == $type->id?'selected':''); ?>><?php echo e($type->name_kh); ?></option>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </select>
                </div>
                ...
                <div class="col-sm-12 col-md-3 col-lg-3 col-xl-3 mb-1">
                    ...
                    <a href="<?php echo e(route('report-financial.expense')); ?>" class="btn btn-warning mb-2">សំអាត</a>                    
                </div>
            </div>
        </form>
    </div>
</div><?php /**PATH D:\OneDrive - Cyber Grow Solution Co., Ltd\Desktop\Loan\Source Code\resources\views/report-financials/expenses/search.blade.php ENDPATH**/ ?>