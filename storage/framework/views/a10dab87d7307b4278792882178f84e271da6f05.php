<div class="card">
    ...
    <div class="card-body">
        ...
        <form action="<?php echo e(route('payment.list.index')); ?>" class="mt-2" id="frmSearch" method="GET">
            <div class="form-row">
                ...
                <div class="col-sm-12 col-md-2 col-lg-2 col-xl-2 mb-1">
                    ...
                    <a href="<?php echo e(route('payment.list.index')); ?>" class="btn btn-warning mb-2">សំអាត</a>
                </div>
            </div>
        </form>
    </div>
</div><?php /**PATH D:\OneDrive - Cyber Grow Solution Co., Ltd\Desktop\Loan\Source Code\resources\views/payments/search.blade.php ENDPATH**/ ?>