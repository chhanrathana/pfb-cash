                ...
                <div class="row">
                    ...
                    <div class="form-group col-sm-4">
                        ...
                        <input
                                ...
                                value="<?php echo e(old('born_place')); ?>"
                                maxlength="250">
                    ...
                    <div class="form-group col-sm-4">
                        ...
                        <select class="form-control select2 <?php echo e($errors->first('document_type') ? 'is-invalid':''); ?>"
                            ...
                            <?php $__currentLoopData = $documents; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $document): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($document->id); ?>" <?php echo e(old('document_type') == $document->id ? 'selected' :  ''); ?>><?php echo e($document->name); ?></option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>
                        <div class="invalid-feedback"><?php echo e($errors->first('documentType')); ?></div>
                    </div>
                </div>
                <div class="row">
                    <div class="form-group col-sm-4">
                ...
                <div class="row">
                    ...
                    <div class="form-group col-sm-4">
                        ...
                        <input
                                ...
                                id="emergency_number"
                                placeholder="0967623XX"
                                value="<?php echo e(old('emergency_number')); ?>"
                                maxlength="50"
                        >
                    ...
                    <div class="form-group col-sm-4">
                        ...
                        <input
                                ...
                                value="<?php echo e(old('current_place')); ?>"
                                maxlength="250">
                    ...
                    <div class="form-group col-sm-4">
                        ...
                        <select class="form-control select2 <?php echo e($errors->first('status') ? 'is-invalid':''); ?>" name="status"
                            ...
                            <?php $__currentLoopData = $status; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $st): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($st->id); ?>" <?php echo e(old('status') == $st->id ? 'selected' :  ''); ?>><?php echo e($st->name); ?></option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Developer\Documents\PFB CASH\Source Code\resources\views/master-data/staffs/create.blade.php ENDPATH**/ ?>