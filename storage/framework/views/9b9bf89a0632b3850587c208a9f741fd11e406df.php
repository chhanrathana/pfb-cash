<?php $__env->startSection('title', 'កែប្រែ-ប្រាក់កម្ចី'); ?>

<?php $__env->startSection('content'); ?>
    <?php echo $__env->make('includes.alert-info', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>

    <form action="<?php echo e(route('loan.twice-weekly.update',['id' => $loan->id ])); ?>" method="POST">
        <?php echo csrf_field(); ?>
        ...
        <div class="card">
            <div class="card-header"> <strong>ព័ត៌មានប្រាក់កម្ចីពីរសប្តាហ៍</strong></div>
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="form-group col-sm-4">
                        ...
                        <input
                            ...
                            value="<?php echo e(old('principal_amount')??$loan->principal_amount); ?>"
                            >
                    ...
                    <div class="form-group col-sm-4">
                        ...
                        <input
                            ...
                            placeholder="2.3"
                            required
                            value="<?php echo e(old('admin_rate')??$loan->admin_rate); ?>"
                            >
                    ...
                    <div class="form-group col-sm-4">
                        ...
                        <input
                            ...
                            type="text"
                            placeholder="2.3"
                            value="<?php echo e($loan->commission_rate); ?>"
                            >
                    ...
                    <div class="form-group col-sm-4">
                        ...
                        <input
                            ...
                            value="<?php echo e(old('registration_date')??$loan->registration_date); ?>"
                            >
                     ...
                     <div class="form-group col-sm-4">
                        ...
                        <input
                            ...
                            data-val="true"
                            placeholder="ថ្ងៃ/ខែ/ឆ្នាំ"
                            value="<?php echo e(old('started_payment_date')??$loan->started_payment_date); ?>"
                            >
                    ...
                    <div class="form-group col-sm-4">
                        ...
                        <input
                            ...
                            type="text"
                            placeholder="12"
                            value="<?php echo e(old('term')??$loan->term); ?>"
                            maxlength="2">
                    ...
                    <div class="form-group col-sm-4">
                        ...
                        <select class="form-control select2 <?php echo e($errors->first('branch_id') ? 'is-invalid':''); ?>" name="branch_id">
                            ...
                            <?php $__currentLoopData = $branches; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $branch): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <?php else: ?>
                                    <option value="<?php echo e($branch->id); ?>" <?php echo e($loan->branch_id == $branch->id ? 'selected' :  ''); ?>><?php echo e($branch->name); ?></option>
                                <?php endif; ?>
            ...
            <div class="card-footer">
                <div class="row">
                    <div class="col">
                        <a class="btn btn-sm btn-warning float-left" href="<?php echo e(route('loan.list.index')); ?>">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\OneDrive - Cyber Grow Solution Co., Ltd\Desktop\Loan\Source Code\resources\views/loans/twice-weekly/edit.blade.php ENDPATH**/ ?>