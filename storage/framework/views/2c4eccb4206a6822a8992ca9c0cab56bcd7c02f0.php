                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="<?php echo e(route('login')); ?>">
                        ...
                        <div class="input-group mb-3">
                            ...
                            <input class="form-control" type="text" name="email" value="<?php echo e(env('APP_ENV') === 'local' ? 'demo' : ''); ?>"  required autofocus>
                        </div>
                        <div class="input-group mb-4">
                            ...
                            <input class="form-control" type="password" name="password" required value="<?php echo e(env('APP_ENV') === 'local' ? '@demo#2022' : ''); ?>">
                        </div>
                        <div class="row">
                            <div class="col-6">
...
<?php echo $__env->make('auth.auth-app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Project\SDT\PFB CASH\Source Code\resources\views/auth/login.blade.php ENDPATH**/ ?>