...
<?php $__env->startSection('html'); ?>
    ...
    <div class="row">
        <table style="width: 100%; font-size:10px" class="table-non-border td-border-non line-height-2">
            ...
            <tr>
                <td>កូដសាខា</td>
                <td><?php echo e($loan->branch->id??''); ?></td>
                <td>ឈ្មោះសាខា</td>
...
<?php echo $__env->make('layouts.pdf-layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\OneDrive - Cyber Grow Solution Co., Ltd\Desktop\Loan\Source Code\resources\views/loans/print-loan.blade.php ENDPATH**/ ?>