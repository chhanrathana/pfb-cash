...
<?php $__env->startSection('content'); ?>
    ...
    <form action="<?php echo e(route('loan.daily.store')); ?>" method="POST">
        ...
        <div class="card">
            <div class="card-header"> <strong>ព័ត៌មានប្រាក់កម្ចីប្រចាំថ្ងៃ</strong></div>
            <div class="card-body">
                <div class="row">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\OneDrive - Cyber Grow Solution Co., Ltd\Desktop\Loan\Source Code\resources\views/loans/daily/create.blade.php ENDPATH**/ ?>