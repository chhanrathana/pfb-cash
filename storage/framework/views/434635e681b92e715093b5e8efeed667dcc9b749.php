    ...
    <div class="card">
        <div class="card-body">            
            <form action="<?php echo e(route('report-staff.revenue-interest')); ?>" class="mt-2" id="frmSearch" method="GET">
                <div class="form-row">
                    ...
                    <div class="col-sm-12 col-md-2 col-lg-2 col-xl-2 mb-1">
                        ...
                        <a href="<?php echo e(route('report-staff.revenue-interest')); ?>" class="btn btn-warning mb-2">សំអាត</a>
                    </div>
                </div>
            </form>
        </div>
    </div><?php /**PATH /home2/kunpheap/public_html/resources/views/report-staffs/revenue-interests/search.blade.php ENDPATH**/ ?>