...
class CalendarController extends Controller
{
    ...
    {        
        ...
        return view('master-data.calendars.index',['calendars'=> $calendars]);
    }
    
    public function create()
    {            
        return view('master-data.calendars.create');
    }
    ...
    {        
        ...
        return view('master-data.calendars.edit', [
            'calendar' => $calendar,
        ]);
    }
    ...
    {        
        ...
        return redirect()->route('master-data.calendar.index');
    }   
    ...
    public function download(Request $request){
        ...
        $html = view('master-data.calendars.print',['calendars' => $calendars, 'year' => $year]);
