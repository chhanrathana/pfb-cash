...
<div class="c-sidebar c-sidebar-dark c-sidebar-fixed c-sidebar-lg-show" id="sidebar">
    <div class="c-sidebar-brand d-lg-down-none">
        <img class="c-sidebar-brand-full" width="300" height="55" src="{{ asset('img/logo.jpg') }}" alt="Loan">
        <img class="c-sidebar-brand-minimized" width="50" height="50" src="{{ asset('img/logo.jpg') }}" alt="Loan">
    </div>
