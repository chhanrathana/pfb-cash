<div class="card">
    <div class="card-header">
        <div class="row">
            ...
            <div class="col">
                <a class="float-right btn btn-md btn-info" href="{{ route('master-data.branch.create') }}">
                ...
                <tbody>
                    ...
                    <tr>
                        <td class="text-center text-nowrap">
                            <a class="btn btn-sm btn-primary" href="{{ route('master-data.branch.edit',['id' => $branch->id]) }}" type="button">
