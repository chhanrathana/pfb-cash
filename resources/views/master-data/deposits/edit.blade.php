                ...
                <div class="row">                             
                    ...
                    <div class="form-group col-sm-4">
                        ...
                        <select class="form-control select2  {{ $errors->first('sex') ? 'is-invalid':'' }}" name="sex"
                            ...
                            @foreach ($sexes as $sex)
                                <option value="{{ $sex->id }}" {{ (old('sex')??$deposit->shareholder->sex) == $sex->id ? 'selected' :  '' }}>{{ $sex->name }}</option>
                    ...
                    <div class="form-group col-sm-4">
                        ...
                        <input
                                ...
                                value="{{ old('date_of_birth')??$deposit->shareholder->date_of_birth }}"
                        >
                    ...
                    <div class="form-group col-sm-4">
                        ...
                        <input
                                ...
                                value="{{ old('born_place')??$deposit->shareholder->born_place }}"
                                maxlength="250">
                    ...
                    <div class="form-group col-sm-4">
                        ...
                        <select class="form-control select2 {{ $errors->first('document_type') ? 'is-invalid':'' }}"
                            ...
                            @foreach ($documents as $document)
                                <option value="{{ $document->id }}" {{ (old('document_type')??$deposit->shareholder->document_type) == $document->id ? 'selected' :  '' }}>{{ $document->name }}</option>                                    
                            @endforeach
                        </select>
                    ...
                    <div class="form-group col-sm-4">
                        ...
                        <input
                                ...
                                value="{{ old('document_number')??$deposit->shareholder->document_number }}"
                                maxlength="50"
                        >
                ...
                <div class="row">
                    <div class="form-group col-sm-4">
                        ...
                        <input
                                ...
                                value="{{ old('phone_number')??$deposit->shareholder->phone_number }}"
                                maxlength="50"
                        >
                    ...
                    <div class="form-group col-sm-4">
                        ...
                        <input
                                ...
                                id="emergency_number"
                                placeholder="0967623XX"                                    
                                value="{{ old('emergency_number')??$deposit->shareholder->emergency_number }}"
                                maxlength="50"
                        >
                    ...
                    <div class="form-group col-sm-4">
                        ...
                        <input
                                ...
                                value="{{ old('current_place')??$deposit->shareholder->current_place }}"
                                maxlength="250">
                ...
                <div class="row">
                    <div class="form-group col-sm-4">
                        ...
                        <input
                                ...
                                data-val-required="Required"
                                placeholder="ថ្ងៃ/ខែ/ឆ្នាំ"
                                value="{{ old('start_work_date')??$deposit->shareholder->start_work_date }}"
                        >
