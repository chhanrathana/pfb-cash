    ...
    <form action="{{ route('master-data.staff.update',['id' => $staff->id]) }}" method="POST">
        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="row">
                    <div class="form-group col-sm-4">
                        ...
                        <input
                                ...
                                value="{{ old('name_kh') ?? $staff -> name_kh }}"
                                maxlength="50">
                    ...
                    <div class="form-group col-sm-4">
                        ...
                        <input
                                ...
                                value="{{ old('name_en') ?? $staff -> name_en }}"
                                maxlength="50">
                    ...
                    <div class="form-group col-sm-4">
                        ...
                        <select class="form-control select2  {{ $errors->first('sex') ? 'is-invalid':'' }}" name="sex"
                            ...
                            @foreach ($sexes as $sex)
                                <option value="{{ $sex->id }}" {{ $staff -> sex == $sex -> id ? 'selected' : '' }}>{{ $sex->name }}</option>
                            @endforeach
                        </select>
                ...
                <div class="row">
                    ...
                    <div class="form-group col-sm-4">
                        ...
                        <input
                                ...
                                value="{{ old('born_place') ?? $staff -> born_place }}"
                                maxlength="250">
                    ...
                    <div class="form-group col-sm-4">
                        ...
                        <select class="form-control select2 {{ $errors->first('document_type') ? 'is-invalid':'' }}"
                            ...
                            @foreach ($documents as $document)
                                <option value="{{ $document->id }}" {{ $staff -> document_type == $document->id ? 'selected' :  '' }}>{{ $document->name }}</option>
                            @endforeach
                        </select>
                ...
                <div class="row">
                    <div class="form-group col-sm-4">
                        <label for="document_number" id="document_number_title">លេខសំគាល់{{$staff->documentTypeName ? $staff -> documentTypeName -> name_kh : 'ឯកសារ'}} <span class="text-danger">*</span></label>
                        <input
                                ...
                                value="{{ old('document_number') ?? $staff -> document_number }}"
                                maxlength="50"
                        >
                ...
                <div class="row">
                    ...
                    <div class="form-group col-sm-4">
                        ...
                        <input
                                ...
                                id="emergency_number"
                                placeholder="0967623XX"
                                value="{{ old('emergency_number') ?? $staff -> emergency_number }}"
                                maxlength="50"
                        >
                    ...
                    <div class="form-group col-sm-4">
                        ...
                        <input
                                ...
                                value="{{ old('current_place') ?? $staff -> current_place }}"
                                maxlength="250">
        ...
        <div class="card">
                ...
                <div class="row">
                    <div class="form-group col-sm-4">
                        ...
                        <input
                                ...
                                data-val-required="Required"
                                placeholder="ថ្ងៃ/ខែ/ឆ្នាំ"
                                value="{{ old('start_work_date') ?? $staff -> start_work_date}}"
                        >
                    ...
                    <div class="form-group col-sm-4">
                        ...
                        <select class="form-control select2 {{ $errors->first('is_admin') ? 'is-invalid':'' }}"
                    ...
                    <div class="form-group col-sm-4">
                        ...
                        <select class="form-control select2 {{ $errors->first('status') ? 'is-invalid':'' }}" name="status"
                            ...
                            @foreach ($status as $st)
                                <option value="{{ $st->id }}" {{ $staff -> status == $st->id ? 'selected' :  '' }}>{{ $st->name }}</option>
                            @endforeach
                        </select>
            ...
            <div class="card-footer">
                <div class="row">
                    <div class="col">
                        <a class="btn btn-sm btn-warning float-left" href="{{ route('master-data.staff.index') }}" title="ថយក្រោយ">
