<div class="card">
    <div class="card-header">
        <div class="row">
            ...
            <div class="col">
                <a class="float-right btn btn-md btn-info" href="{{ route('master-data.calendar.create') }}">
                     <strong>បញ្ចូលថ្មី</strong>
                </a>
                <a class="btn btn-sm btn-warning float-right mb-2"
                    style="margin-right: 5px;"
                    target="_blank"            
                    href="{{ route('master-data.calendar.download').currentParamter() }}"
                    >
                ...
                <tbody>
                    ...
                    <tr>
                        <td class="text-center text-nowrap">
                            <a class="btn btn-sm btn-primary" href="{{ route('master-data.calendar.edit',['id' => $calendar->id]) }}" type="button">
