    ...
    <div class="card-body">
        <div class="row">
            ...
            <div class="form-group col-sm-4">
                ...
                <select class="form-control select2  {{ $errors->first('loaner_sex') ? 'is-invalid':'' }}"  name="loaner_sex" id="sex">
            ...
            <div class="form-group col-sm-4">
                ...
                <select class="form-control select2 {{ $errors->first('loaner_province_id') ? 'is-invalid':'' }}" name="loaner_province_id" id="province_id">
                    <option value="" selected>[-- ជ្រើសរើស --]</option>
            ...
            <div class="form-group col-sm-4">
                ...
                <select class="form-control select2 {{ $errors->first('district_id') ? 'is-invalid':'' }}" name="loaner_district_id" id="district_id">
                    <option value="" selected>[-- ជ្រើសរើស --]</option>
                        @if ($client)
            ...
            <div class="form-group col-sm-4">
                ...
                <select class="form-control select2 {{ $errors->first('commune_id') ? 'is-invalid':'' }}" name="loaner_commune_id" id="commune_id">
                    <option value="" selected>[-- ជ្រើសរើស --]</option>
                        @if ($client)
            ...
            <div class="form-group col-sm-4">
                ...
                <select class="form-control select2 {{ $errors->first('village_id') ? 'is-invalid':'' }}" name="loaner_village_id" id="village_id">
                    <option value="" selected>[-- ជ្រើសរើស --]</option>
                    @if ($client)
...
<div class="card">
    ...
    <div class="card-body">
        <div class="row">
            ...
            <div class="form-group col-sm-4">
                <label >ភេទ</label>
                <select class="form-control select2  {{ $errors->first('first_guarantor_sex') ? 'is-invalid':'' }}"  name="first_guarantor_sex" id="sex">
                    <option value="" selected>[-- ជ្រើសរើស --]</option>
                    @foreach ($sexes as $sex)
                        @if ($first_guarantor)
...
<div class="card">
    <div class="card-body">
        <div class="row">
            ...
            <div class="form-group col-sm-4">
                <label >ភេទ</label>
                <select class="form-control select2  {{ $errors->first('second_guarantor_sex') ? 'is-invalid':'' }}"  name="second_guarantor_sex" id="sex">
                    <option value="" selected>[-- ជ្រើសរើស --]</option>
                    @foreach ($sexes as $sex)
                        @if ($second_guarantor)
