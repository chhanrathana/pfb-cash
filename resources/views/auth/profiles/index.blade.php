        ...
        <div class="card-body">
            <div class="row">
                <div class="col-sm-12 col-md-3">
                    ...
                    <h4 class="text-center mt-2 text-success"><b>{{ $user->name }}</b></h4>
                    <h6 class="text-center mt-2 text-primary"><b>{{ $user->type->name??'' }}</b></h6>
                ...
                <div class="col-sm-12 col-md-9">
                    <table class="table table-bordered table-striped table-hover" id ="table">
                        ...
                        <tr>
                            <td><b>ឈ្មោះ</b></td>
                            <td><b class="float-right">{{ $user->name ?? '' }}</b></td>
                        </tr>
                        <tr>
                            <td><b>តួនាទីអ្នកប្រើប្រាស់</b></td>
                            <td><b class="float-right">{{ $user->type->name??'' }}</b></td>
                        </tr>                       
                        </tbody>
                    </table>
