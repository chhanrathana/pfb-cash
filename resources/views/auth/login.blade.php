    ...
    <div class="col-md-8">
                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ route('login') }}">
                        ...
                        <div class="input-group mb-3">
                            ...
                            <input class="form-control" type="text" name="email" value="{{ env('APP_ENV') === 'local' ? 'demo' : '' }}"  required autofocus>
                        </div>
                        <div class="input-group mb-4">
                            ...
                            <input class="form-control" type="password" name="password" required value="{{ env('APP_ENV') === 'local' ? '@demo#2022' : '' }}">
                        </div>
                        <div class="row">
                            <div class="col-6">
        ...
        <div class="card text-white bg-secondary py-5 d-md-down-none" style="width:44%">
            <div class="card-body text-center">
                <img class="img-fluid max-height" src="{{ asset('img/brand.png') }}" alt="">
            </div>
        </div>
    </div>
    <div class="container">
